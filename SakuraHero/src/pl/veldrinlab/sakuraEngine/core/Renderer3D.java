...
/**
 * Class represents Core element of SakuraEngine - pure static Renderer3D class. It is collection of default, global rendering data like camera, sprite batch, font
...
public class Renderer3D {
	...
	public static void renderEntity(final SceneEntity3D entity) {
		entity.shader.begin();
	...
	public static void renderEntity(final SceneEntity3D entity, final Mesh subMesh) {
		entity.shader.begin();
		modelViewProjectionMatrix.set(camera.projection).mul(camera.view).mul(entity.modelMatrix);
		modelViewMatrix.set(camera.view).mul(entity.modelMatrix);
		entity.shader.setUniformMatrix("u_mvpMatrix",modelViewProjectionMatrix);
	...
	public static void renderEntity(final SceneEntity3D entity, final Camera cam) {			
		entity.shader.begin();
