 ...
 *
 */
public abstract class SceneEntity3D {
	...
	public SceneEntity3D parent;
	public SceneEntity3D leftBrother;
	public SceneEntity3D rightBrother;
	 ...
	 * @param shader
	 */
	public SceneEntity3D(final Mesh mesh, final Texture texture, final ShaderProgram shader) {
		this.mesh = mesh;
